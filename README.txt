...
- Aprire una nuova scheda del cmd o di PowerShell (nel caso in cui non fosse possibile aprire cmd se si ha aperto PowerShell o aprire cmd se hai aperto PowerShell (su macOS cliccare con il tasto destro sull'app "terminale" e premere "nuova finestra")
- Digitare "cd Desktop"
- Digitare "cd uniperfidaProgettoMap"
- Digitare "cd uniperfida"
- Digitare "cd target"
